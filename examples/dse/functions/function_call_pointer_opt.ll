; ModuleID = 'function_call_pointer.ll'
source_filename = "function_call_pointer.c"
...
define dso_local void @_Z3fooPi(ptr noundef %0) #0 {
...
define dso_local noundef i32 @main() #2 {
  ...
  call void @_Z3fooPi(ptr noundef %2)
